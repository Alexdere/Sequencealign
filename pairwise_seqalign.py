...
#gap_penalty = -1  # Define your gap penalty here
...
def draw_board(canvas, x1, y1, x2, y2, mat,boolean, path ):
    ...
    debug_mode = boolean
    #print(debug_mode)
    #path = [[7, 7], [6, 6], [5, 5], [4, 5], [3, 4], [3, 3], [2, 2]]
    ...
    canvas.create_text(330, 15, anchor = "center", text = aligned[0:-2], font = "Arial 15",fill = "black" )
    canvas.create_text(330, 35, anchor = "center", text = aligned[1:-1], font = "Arial 15",fill = "black" )
    canvas.create_text(70, 15, anchor = "center", text = aligned[0:-2], font = "Arial 15",fill = "black" )
    canvas.create_text(70, 35, anchor = "center", text = aligned[1:-1], font = "Arial 15",fill = "black" )
